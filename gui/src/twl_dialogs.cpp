...
TColourDialog::TColourDialog(TWin* win, COLORREF cl)
{
	...
	m_choose_color.hwndOwner = (HWND)win->handle();
...
{
	return ChooseColor(&m_choose_color);
}

COLORREF TColourDialog::result()
{
