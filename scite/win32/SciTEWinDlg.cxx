...
void SciTEWin::UserStripSet(int control, const char *value) {
	if (userStrip.visible) userStrip.Set(control, value); // RB:condition visible added
}
...
void SciTEWin::UserStripSetList(int control, const char *value) {
	if (userStrip.visible) userStrip.SetList(control, value); // RB:condition visible added
}
